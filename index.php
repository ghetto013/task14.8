...
<body>
                            ...
                            if (key_exists('date', $_SESSION)) {
                                ...
                                switch ($current_birthday <=> $now) {
                                    case 1:
                                        ...
                                        break;
                                    case 0:
                                        $days = 'Поздравляем с днем рождения';
                                        $discount = 0.85;
                                        break;
                                    case -1:
    ...
    <section class="services">
        ...
        <div class="services">
            ...
            ?>
                    <div class="service">
                        <h4>Енотик делает массаж</h4>
                        <p class="discount">Индивидуальное предложение действует: <span><?= "{$h}ч {$m}м {$s}с" ?> </span></p>
                        <img src='img/3.jpeg' width="650px">
                        <p>Цена: <span>5000 руб.</span></p>
                        <?php
                        $discount = $discount ?? NULL;
                        if ($discount) {
                        ?>
                            <p style="color: red">Цена со скидкой: <span><?= 5000 * $discount ?> руб.</span></p>
                        <?php
                        }
                        ?>
                    </div>
            ...
            ?>
            <div class="service">
                <h4>Кошка делает массаж</h4>
                <img src='img/1.webp' width="650px">
                <p>Цена: <span>5000 руб.</span></p>
                <?php
                $discount = $discount ?? NULL;
                if ($discount) {
            ...
            <div class="service">
                <h4>Собачка делает массаж</h4>
                <img src='img/2.webp' width="650px">
                <p>Цена: <span>5000 руб.</span></p>
                <?php
                $discount = $discount ?? NULL;
                if ($discount) {
